#!/usr/bin/env python3
"""
Fast export of Digivice names from Digivice.bin.

Usage:
    python export_digivice_names.py Digivice.bin replace_map.csv digivice_names.csv
...
def main():
    if len(sys.argv) < 4:
        print("Usage: python export_digivice_names.py Digivice.bin replace_map.csv digivice_names.csv")
        return
    ...
    print("[*] Extracting Digivice names...")
